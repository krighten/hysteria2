...
**🙃安装脚本(首先推荐ubuntu的系统):**
```
curl -sSL https://github.com/krighten/hysteria2/raw/main/sbox_hy2.sh -o sbox_hy2.sh && chmod +x sbox_hy2.sh && bash sbox_hy2.sh
```
...
# AD 😇
1.比较好用的低价服务器,听说是加拿大华人的,线路非常,几十ms的延迟

点击直达(非常推荐)————
[**超低延迟机器**](https://app.vmiss.com/aff.php?aff=1770)
